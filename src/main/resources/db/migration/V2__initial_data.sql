...
values ('student1_name', 1000, 1, 1),
       ('teacher1_name', 10000, 1, 2),
       ('university_admin1_name', 10000, 1, 3),
       ('global_admin1_name', 10000, null, 4);
...
values ('Document 1', 'Science', 'Description for Document 1', '/path/to/document1.pdf', 1.4, 1),
       ('Document 2', 'Science', 'Description for Document 2', '/path/to/document2.pdf', 1.5, 2),
       ('Document 3', 'Science', 'Description for Document 3', '/path/to/document3.pdf', 2.4, 3),
       ('Document 4', 'Math Science', 'Description for Document 4', '/path/to/document4.pdf', 4.5, 1),
       ('Document 5', 'Math', 'Description for Document 5', '/path/to/document5.pdf', 3.1, 2),
       ('Document 6', 'History', 'Description for Document 6', '/path/to/document6.pdf', 3.5, 3);
